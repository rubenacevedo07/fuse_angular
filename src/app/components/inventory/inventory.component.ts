...
export interface StarshipElement {
  name: string;
  model: string;
  manufacturer: string;
...
const STARSHIPS: StarshipElement[] = [
  {
    name: "CR90 corvette",
    model: "CR90 corvette",
...
export class InventoryComponent {
  displayedColumns: string[] = ['name', 'model', 'manufacturer', 'cost_in_credits'];
  dataSource!: any;
  isLoading = true;
...
// -----------------------------------------------------------------------------------------------------
  ...
  getShips(): Observable<any> {
      return this.httpClient
        .get<any>('https://localhost:32794/api/Starships');//https://localhost:32790/api/Starships
  }

  loadShips() {    
      return this.getShips().subscribe((data1: {}) => {
