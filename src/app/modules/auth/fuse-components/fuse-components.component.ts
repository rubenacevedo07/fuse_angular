                ...
                children: [
                    {
                        ...
                        title: 'MockAPI',
                        type : 'basic',
                        link : '/fuse-components/libraries/mock-api'
                    }
                ]
            },
            {
                ...
                children: [
                    {
                        ...
                        title: 'Alert',
                        type : 'basic',
                        link : '/fuse-components/components/alert'
                    },
                    {
                        id   : 'fuse-components.components.card',
                        title: 'Card',
                        type : 'basic',
                        link : '/fuse-components/components/card'
                    },
                    {
                        id   : 'fuse-components.components.drawer',
                        title: 'Drawer',
                        type : 'basic',
                        link : '/fuse-components/components/drawer'
                    },
                    {
                        id   : 'fuse-components.components.fullscreen',
                        title: 'Fullscreen',
                        type : 'basic',
                        link : '/fuse-components/components/fullscreen'
                    },
                    {
                        id   : 'fuse-components.components.highlight',
                        title: 'Highlight',
                        type : 'basic',
                        link : '/fuse-components/components/highlight'
                    },
                    {
                        id   : 'fuse-components.components.loading-bar',
                        title: 'Loading Bar',
                        type : 'basic',
                        link : '/fuse-components/components/loading-bar'
                    },
                    {
                        id   : 'fuse-components.components.masonry',
                        title: 'Masonry',
                        type : 'basic',
                        link : '/fuse-components/components/masonry'
                    },
                    {
                        id   : 'fuse-components.components.navigation',
                        title: 'Navigation',
                        type : 'basic',
                        link : '/fuse-components/components/navigation'
                    }
                ]
            },
            {
                ...
                children: [
                    {
                        ...
                        title: 'Scrollbar',
                        type : 'basic',
                        link : '/fuse-components/directives/scrollbar'
                    },
                    {
                        id   : 'fuse-components.directives.scroll-reset',
                        title: 'ScrollReset',
                        type : 'basic',
                        link : '/fuse-components/directives/scroll-reset'
                    }
                ]
            },
            {
                ...
                children: [
                    {
                        ...
                        title: 'Config',
                        type : 'basic',
                        link : '/fuse-components/services/config'
                    },
                    {
                        id   : 'fuse-components.services.confirmation',
                        title: 'Confirmation',
                        type : 'basic',
                        link : '/fuse-components/services/confirmation'
                    },
                    {
                        id   : 'fuse-components.services.splash-screen',
                        title: 'SplashScreen',
                        type : 'basic',
                        link : '/fuse-components/services/splash-screen'
                    },
                    {
                        id   : 'fuse-components.services.media-watcher',
                        title: 'MediaWatcher',
                        type : 'basic',
                        link : '/fuse-components/services/media-watcher'
                    }
                ]
            },
            {
                ...
                children: [
                    {
                        ...
                        title: 'FindByKey',
                        type : 'basic',
                        link : '/fuse-components/pipes/find-by-key'
                    }
                ]
            },
            {
                ...
                children: [
                    {
                        ...
                        title: 'MustMatch',
                        type : 'basic',
                        link : '/fuse-components/validators/must-match'
                    }
                ]
            }
        ];
